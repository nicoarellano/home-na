  ...
  return (
    ...
    >
      ...
      <p>
        ...
        the revised Privacy Policy on the Service. The revised Policy will be effective 180 days from
        when the revised Policy is posted in the Service and your continued access or use of the Service
      ...
      <ol>
        ...
        <li>
          ...
          <p>
            We require such third parties to use the personal information we transfer to them only
          ...
          <p>
            ...
            agreements with us, including this Privacy Policy; or (3) to respond to claims that
            your use of the Service violates any third-party rights. If the Service or our company
            is merged or acquired with another company, your information will be one of the assets
        ...
        <li>
          ...
          <p>
            ...
            terminate their accounts or for as long as we need it to fulfill the purposes for which
            it was collected as detailed in this Privacy Policy. We may need to retain certain
            information for longer periods such as record-keeping / reporting in accordance with
            applicable law or for other legitimate reasons like enforcement of legal rights, fraud
            prevention, etc. Residual anonymous information and aggregate information, neither of
        ...
        <li>
          ...
          <p>
            ...
            another entity, withdraw any consent you provided to us to process your data, a right
            to lodge a complaint with a statutory authority and such other rights as may be relevant
            under applicable laws. To exercise these rights, you can write to us at{' '}
            <a href="mailto:info@collabdt.org">info@collabdt.org</a>. We will respond to your
        ...
        <li>
          ...
          <p>
            ...
            available with us, you may email our Grievance Officer at Carleton Immersive Media
            Studio, Visualization and Simulation Bldg, 1125 Colonel By Drive, email:{' '}
            <a href="mailto:info@collabdt.org">info@collabdt.org</a>. We will address your
