...
export interface CdtIconProps {
  className?: string
  size?: number | string
  monochromatic?: boolean
}

export const CdtIcon = ({ className = 'h-4 w-4', size, monochromatic = false }: CdtIconProps) => {
  return (
    <svg
      id='cdt-logo'
